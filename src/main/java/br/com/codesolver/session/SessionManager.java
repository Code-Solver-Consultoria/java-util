...
public interface SessionManager<T extends Session> {
	 ...
	 * @return Session
	 */
	public abstract <V> T get(SessionParam<V> param, V value);
	 ...
	 * @return Session
	 */
	public abstract <V> T get(SessionParam<V> param, V value, boolean create);	
	 ...
	 */
	public abstract <V> T remove(SessionParam<V> param, V value);
