 ...
 * @since 2025-08-26
 */
public class TimeRuntimeException extends RuntimeException {
    
    /**
     * Constrói uma nova {@code TimeRuntimeException} com {@code null} como mensagem de detalhe.
    ...
    /**
     * Constrói uma nova {@code TimeRuntimeException} com a mensagem de detalhe especificada.
     *
     * @param message mensagem explicando o motivo da exceção
     */
    public TimeRuntimeException(String message) {
        super(message);
    }

    /**
     * Constrói uma nova {@code TimeRuntimeException} com a mensagem de detalhe e causa especificadas.
     *
     ...
     */
    public TimeRuntimeException(String message, Throwable cause) {
        super(message, cause);
    }

    /**
     * Constrói uma nova {@code TimeRuntimeException} com a causa especificada.
     *
     * @param cause causa subjacente desta exceção
     */
    public TimeRuntimeException(Throwable cause) {
        super(cause);
    }

    /**
     * Constrói uma nova {@code TimeRuntimeException} com mensagem de detalhe, causa,
     ...
     */
    protected TimeRuntimeException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
