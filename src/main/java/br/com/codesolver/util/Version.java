 ...
 * </ul>
 * <p>
 * Onde a versão deve sempre ser composta por três identificadores separados por
 * ponto.
 * </p>
 * 
...
public class Version implements Serializable {
	...
	/**
	 * Nome do aplicativo, retirado do arquivo MANIFEST.MF, entrada
	 * <b>Specification-Title</b>.
	 */
	private String name;

	/**
	 * Maior número da versão do aplicativo, retirado do arquivo MANIFEST.MF, entrda
	 * <b>Specification-Version</b>.
	 */
	private String major;

	/**
	 * Menor número da versão do aplicativo, retirado do arquivo MANIFEST.MF, entrda
	 * <b>Specification-Version</b>.
	 */
	private String minor;

	/**
	 * Identificador da construção da versão do aplicativo, retirado do arquivo
	 * MANIFEST.MF, entrda <b>Specification-Version</b>.
	 */
	 ...
	 * @throws VersionRuntimeException Falha na decomposição da versão extraída do
	 *                                 pacote.
	...
	public void decode(Package pack) {
		try {
			...
			throw new VersionRuntimeException(
					"Formato de versão incorreto. Deve possuir 3 identificadores separados por ponto (.).", e);
		} catch (NullPointerException e) {
			throw new VersionRuntimeException("Nenhuma informação pode ser extraída do pacote fornecido.", e);
		}
	}
}
