...
public class UUIDGeneratorVersionInvalid extends RuntimeException {
    ...
    /**
     * Constrói uma nova {@code UUIDGeneratorVersionInvalid} com {@code null} como mensagem de detalhe.
    ...
    /**
     * Constrói uma nova {@code UUIDGeneratorVersionInvalid} com a mensagem de detalhe especificada.
     *
     * @param message mensagem explicando o motivo da exceção
     */
    public UUIDGeneratorVersionInvalid(String message) {
        super(message);
    }

    /**
     * Constrói uma nova {@code UUIDGeneratorVersionInvalid} com a mensagem de detalhe e causa especificadas.
     *
     ...
     */
    public UUIDGeneratorVersionInvalid(String message, Throwable cause) {
        super(message, cause);
    }

    /**
     * Constrói uma nova {@code UUIDGeneratorVersionInvalid} com a causa especificada.
     *
     * @param cause causa subjacente desta exceção
     */
    public UUIDGeneratorVersionInvalid(Throwable cause) {
        super(cause);
    }

    /**
     * Constrói uma nova {@code UUIDGeneratorVersionInvalid} com mensagem de detalhe, causa,
